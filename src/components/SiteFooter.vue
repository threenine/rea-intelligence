<template>
  <footer class="text-gray-700 text-sm leading-normal flex flex-wrap justify-between mx-auto max-w-3xl px-6 sm:px-12">
    <div class="w-full sm:w-1/2 mb-4 sm:mb-0">
      <p><a href="https://rea-intelligence.com" class="border-b border-transparent hover:border-gray-400 transition-border-color">REA Intelligence</a> by <a href="https://threenine.co.uk" class="border-b border-transparent hover:border-gray-400 transition-border-color">threenine.co.uk</a></p>
